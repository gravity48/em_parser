...
from sqlalchemy import Integer, Text, Column, ForeignKey,Boolean, Sequence, String, VARCHAR, BigInteger, DateTime, BLOB
...
class Users(Base):
    ...
    def __init__(self, user_id: int, username: str, first_name: str, last_name: str, chat_id: int, *args, **kwargs):
...
class PatientEvents(Base):
    ...
    def __init__(self, event_id: str, header: str, status: str, body: str, date: datetime, person_id=None, *args, **kwargs):
...
__all__ = ['Users', 'Patients', 'PatientEvents', 'Tasks']
