...
from database import PatientEvents
from settings import DataBase, ApiWrapper
from parsers import Parser, PersonDetailView, WardsPatientViews, EventDetailView
...
def _events_db_to_named_tuple(patients_event_list: List[List[PatientEvents]]) -> List[Set[EventDetailView]]:
    result = []
